...
# make gcov - will compile "all" with $(CXXFLAGS) and the -fprofile-arcs and
# -ftest-coverage flags (for gcov)
...
sync2caen:
	...
	rsync \
      ...
      --filter=":- .gitignore" \
      "."/ \
      "njohari@login.engin.umich.edu:'${REMOTE_PATH}/'"
